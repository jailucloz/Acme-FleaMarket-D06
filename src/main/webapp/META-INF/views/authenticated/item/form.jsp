...
<acme:form readonly="true">
	...
	<acme:form-textarea code="authenticated.item.form.label.descriptionText" path="descriptionText"/>
	<acme:form-money code="authenticated.item.form.label.price" path="price"/>
	<acme:form-textbox code="authenticated.item.form.label.additionalInformation" path="additionalInformation"/>
