...
@Service
public class SupplierRequestListOrderService implements AbstractListService<Supplier, RequestItem> {
	...
	public Collection<RequestItem> findMany(final Request<RequestItem> request) {
		...
		result = this.repository.findManyRequestBySupplierOrderBy(employerId);
