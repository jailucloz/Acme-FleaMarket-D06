...
@Service
public class AdministratorSuggestionsDeleteService implements AbstractDeleteService<Administrator, Suggestion> {
	...
	// AbstractDeleteService<Administrator, Suggestion> interface -------------------------
